...
function ProductSale({ setCart, cart }) {
    ...
    const renderProductSale = () => {
        if (localPath == '/nuochoa') {
            return product.perfume && product.perfume.length > 0 && product.perfume.map((item, i) => {
                return item.sale > 0 ?
                    (<div className="col-lg-3 col-md-6 col-sm-12 mb-30" key={item._id}>
            ...
            return product.makeup && product.makeup.length > 0 && product.makeup.length > 0 && product.makeup.map((item, i) => {
                return item.sale > 0 ? (<div className="col-lg-3 col-md-6 col-sm-12 mb-30" key={item._id}>
                    <div className="product__new-item">
                        <div className="card" style={{ width: "100%" }}>
            ...
            return arrSale && arrSale.length > 0 && arrSale.length > 0 && arrSale.map((item, i) => {
                return item.sale > 0 ? (<div className="col-lg-3 col-md-6 col-sm-12 mb-30" key={item._id}>
                    <div className="product__new-item">
                        <div className="card" style={{ width: "100%" }}>
    ...
    return (
        <>
            ...
            <div className="product__new">
                <h3 className="product__ne title-product1"><ins>Đang khuyến mãi</ins></h3>
